...
from dags.config import GENERATED_DATA_PATH, DATA_FOLDER, MODEL_PATH
...
def predict():
    ...
    def predict_with_io_task(feature_path: str) -> None:
        predict_with_io(feature_path=feature_path, model_path=MODEL_PATH, predictions_folder=GENERATED_DATA_PATH)
        return features_path
